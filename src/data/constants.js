...
export const MUSIC_LINKS = [
  ...
  { name: 'Apple Music',  icon: '♪', color: '#fc3c44', bg: 'rgba(252,60,68,0.1)',   url: 'https://music.apple.com/us/album/kyle-california/1232990861?i=1232990862' },
  ...
  { name: 'Spotify',      icon: '♫', color: '#1db954', bg: 'rgba(29,185,84,0.1)',   url: 'https://open.spotify.com/track/6rqhFgbbKwnb9MLmUQDhG6' },
];
