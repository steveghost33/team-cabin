...
export const MUSIC_LINKS = [
  { name: 'Bandcamp',     icon: '◎', color: '#1da0c3', bg: 'rgba(29,160,195,0.1)',  url: 'https://teamcabin.bandcamp.com/track/kyle-california' },
  { name: 'Apple Music',  icon: '♪', color: '#fc3c44', bg: 'rgba(252,60,68,0.1)',   url: 'https://music.apple.com/id/song/kyle-california/1888332066' },
  ...
  { name: 'Spotify',      icon: '♫', color: '#1db954', bg: 'rgba(29,185,84,0.1)',   url: 'https://open.spotify.com/track/5sy7IMLtU4AN7GegQLLDxd?si=990e611a775d4df5' },
];
