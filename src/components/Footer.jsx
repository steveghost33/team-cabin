      ...
      <div style={{
        ...
        {SOCIAL_LINKS.map((l) => (
          <a key={l.label} href={l.url} style={{
            ...
            onMouseEnter={e => { e.currentTarget.style.transform='translate(-2px,-2px)'; e.currentTarget.style.color=C.gold; }}
            onMouseLeave={e => { e.currentTarget.style.transform=''; e.currentTarget.style.color=C.goldL; }}
          >{l.label}</a>
        ))}
      </div>
      <div style={{ height:2, background:`repeating-linear-gradient(90deg,${C.goldD} 0,${C.goldD} 6px,transparent 6px,transparent 12px)`, marginBottom:'1.5rem', maxWidth:400, margin:'0 auto 1.5rem', opacity:0.4 }} />
      <p style={{ fontFamily:'"Press Start 2P"', fontSize:'0.3rem', color:'rgba(226,168,32,0.28)', marginBottom:'0.4rem' }}>
