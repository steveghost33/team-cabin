...
//  viewBox 0 0 32 32, fits any size box
// ─────────────────────────────────────
...
export function CharLeft({ size = 64, animate = true, delay = '0s' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32"
      ...
      <rect x="8"  y="1"  width="16" height="2" fill="#8a7045" opacity="0.35" />
      {/* beard */}
...
export function CharMid({ size = 64, animate = true, delay = '0.25s' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32"
      ...
      <rect x="5"  y="31" width="8" height="1" fill="#fff" opacity="0.25" />
      <rect x="19" y="31" width="8" height="1" fill="#fff" opacity="0.25" />
      {/* maroon pants */}
      ...
      {/* mustard yellow fitted snapback — tight, small brim */}
...
// KYLE — dark olive Patagonia zip fleece, brown hair, glasses, dark pants, brown boots
