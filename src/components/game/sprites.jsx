export function drawCharSprite(ctx, idx, px, py, PW, C) {
  ...
  if (idx === 0) {
    // STEVE — plaid flannel, sandy beard+hair, glasses
    ...
    r(0,26,8,3,'#111'); r(13,26,8,3,'#111');
    r(0,31,8,1,'#eee'); r(13,31,8,1,'#eee');
    ...
    r(0,26,8,3,'#5a3a20'); r(13,26,8,3,'#5a3a20');
    r(0,31,8,1,'#7a5a40'); r(13,31,8,1,'#7a5a40');
...
export function drawPizzaSlice(ctx, ox, py, C) {
  ...
  ctx.beginPath();ctx.moveTo(ox+14,py+2);ctx.lineTo(ox,py+26);ctx.lineTo(ox+28,py+26);ctx.closePath();ctx.fill();
  ctx.fillStyle='#FFD966';
  ctx.beginPath();ctx.moveTo(ox+14,py+6);ctx.lineTo(ox+3,py+24);ctx.lineTo(ox+25,py+24);ctx.closePath();ctx.fill();
  ctx.fillStyle='#C0392B';
  ctx.beginPath();ctx.moveTo(ox+14,py+9);ctx.lineTo(ox+6,py+23);ctx.lineTo(ox+22,py+23);ctx.closePath();ctx.fill();
  ctx.fillStyle='#b8750a';
  [ox+2,ox+7,ox+13,ox+19,ox+24].forEach(x=>{ctx.beginPath();ctx.arc(x,py+26,3,0,Math.PI*2);ctx.fill();});
  ctx.fillStyle='#8B0000';
  [[ox+11,py+13],[ox+17,py+17],[ox+9,py+19]].forEach(([cx,cy])=>{ctx.beginPath();ctx.arc(cx,cy,3,0,Math.PI*2);ctx.fill();});
  ctx.fillStyle=gld; ctx.font='8px "Press Start 2P"'; ctx.textAlign='center';
  ctx.fillText('+100',ox+14,py-4);
}
...
export function drawTaco(ctx, ox, py, C) {
  ...
  ctx.fillStyle='#27ae60';[ox+4,ox+8,ox+12,ox+16,ox+20].forEach(x=>ctx.fillRect(x,py+8,3,5));
  ctx.fillStyle='#8B4513';ctx.fillRect(ox+5,py+12,18,4);
  ctx.fillStyle='#FFD700';ctx.fillRect(ox+6,py+11,16,3);
  ctx.fillStyle='#e74c3c';[ox+7,ox+13,ox+18].forEach(x=>{ctx.beginPath();ctx.arc(x,py+13,2,0,Math.PI*2);ctx.fill();});
  ctx.fillStyle=gld; ctx.font='8px "Press Start 2P"'; ctx.textAlign='center';
  ctx.fillText('+100',ox+14,py-4);
}
...
export function drawEnemySprite(ctx, o, scrollX, C) {
  ...
  if (o.type === 'cone') {
    ...
    ctx.beginPath();ctx.moveTo(ox,oy+6);ctx.quadraticCurveTo(ox-7,oy+11,ox-10,oy+6);ctx.stroke();
    ctx.fillStyle='#6a6060'; ctx.beginPath();ctx.ellipse(ox+6,oy+6,6,5,0,0,Math.PI*2);ctx.fill();
    ctx.fillStyle='#8a8080'; ctx.beginPath();ctx.ellipse(ox+6,oy+5,4,3,0,0,Math.PI*2);ctx.fill();
    ctx.fillStyle='#6a6060'; ctx.beginPath();ctx.ellipse(ox+11,oy+4,4,3,0,0,Math.PI*2);ctx.fill();
    ctx.fillStyle='#7a7070'; ctx.beginPath();ctx.ellipse(ox+12,oy+3,2.5,2,0,0,Math.PI*2);ctx.fill();
    ctx.fillStyle='#c87070'; ctx.beginPath();ctx.ellipse(ox+10,oy+1,2,3,-.2,0,Math.PI*2);ctx.fill();
    ctx.fillStyle='#e89090'; ctx.beginPath();ctx.ellipse(ox+10,oy+1,1,2,-.2,0,Math.PI*2);ctx.fill();
    ...
    ctx.fillStyle=C.gold||'#E2A820'; ctx.fillRect(ox+9,oy+14,6,5);
    ...
    ctx.fillStyle=C.gold||'#E2A820'; ctx.fillRect(ox+7,oy-1,10,2);
    ...
    ctx.fillStyle='#fff'; ctx.font='5px sans-serif'; ctx.textAlign='center'; ctx.fillText('NO PKG',ox+12,oy+17);
    ...
    ctx.fillStyle='#e74c3c'; ctx.fillRect(ox+9,oy,3,2); ctx.fillRect(ox+13,oy,3,2);
  }
}
...
export function drawBossSprite(ctx, boss, scrollX, bossHp, bossMaxHp, C) {
  ...
  if (boss.type === 'landlord') {
    ...
    ctx.fillStyle=angry?'#aa1010':'#5a5a7a'; ctx.fillRect(bx+4,by+20,boss.w-8,12);
    ...
    ctx.fillStyle='#e74c3c'; ctx.font='5px sans-serif'; ctx.textAlign='center'; ctx.fillText('EVICT',bx+boss.w+11,by+42);
    ctx.fillStyle=angry?'#d4604a':'#d4905a'; ctx.fillRect(bx+12,by-10,36,32);
    ctx.fillStyle=angry?'#e47060':'#e4a06a'; ctx.fillRect(bx+14,by-10,32,10);
    ...
    // RECORD EXEC
    const bx = ox, by = oy + bob;
    ctx.fillStyle='#111'; ctx.fillRect(bx+4,by+72,14,6); ctx.fillRect(bx+38,by+72,14,6);
    ctx.fillStyle='#1a1a1a'; ctx.fillRect(bx+8,by+50,12,24); ctx.fillRect(bx+40,by+50,12,24);
    ctx.fillStyle=angry?'#5a0020':'#6a0030'; ctx.fillRect(bx,by+18,boss.w,34);
    ctx.fillStyle=angry?'#7a0030':'#8a0040'; ctx.fillRect(bx+4,by+18,boss.w-8,12);
    ctx.fillStyle='#f0f0f0'; ctx.fillRect(bx+20,by+18,16,12);
    ctx.fillStyle='#111'; ctx.beginPath();ctx.arc(bx+28,by+28,6,0,Math.PI*2);ctx.fill();
    ctx.fillStyle='#cc0000'; ctx.beginPath();ctx.arc(bx+28,by+28,5,0,Math.PI*2);ctx.fill();
    ctx.fillStyle='#FFD700'; ctx.font='5px sans-serif'; ctx.textAlign='center'; ctx.fillText('REC',bx+28,by+31);
    ctx.fillStyle=angry?'#6a0030':'#7a0040';
    ctx.beginPath();ctx.moveTo(bx+20,by+18);ctx.lineTo(bx+12,by+34);ctx.lineTo(bx+20,by+36);ctx.closePath();ctx.fill();
    ctx.beginPath();ctx.moveTo(bx+44,by+18);ctx.lineTo(bx+52,by+34);ctx.lineTo(bx+44,by+36);ctx.closePath();ctx.fill();
    ctx.strokeStyle='#FFD700'; ctx.lineWidth=3; ctx.beginPath();ctx.arc(bx+28,by+36,10,0,Math.PI);ctx.stroke();
    ...
    ctx.fillText('SIGN',bx-6,by+38); ctx.fillText('HERE',bx-6,by+43);
    ctx.fillStyle='#FFD700'; ctx.fillRect(bx+boss.w+4,by+34,4,20);
    ctx.fillStyle='#c8a070'; ctx.fillRect(bx+12,by-8,boss.w-24,34);
    ctx.fillStyle='#0a0a0a'; ctx.fillRect(bx+12,by-8,boss.w-24,8);
    ctx.fillStyle='#111'; ctx.fillRect(bx+14,by+4,14,10); ctx.fillRect(bx+32,by+4,14,10);
    ctx.strokeStyle='#888'; ctx.lineWidth=2; ctx.strokeRect(bx+14,by+4,14,10); ctx.strokeRect(bx+32,by+4,14,10);
    ctx.fillStyle='rgba(255,255,255,0.1)'; ctx.fillRect(bx+15,by+5,5,5); ctx.fillRect(bx+33,by+5,5,5);
  ...
  ctx.fillStyle='rgba(0,0,0,0.7)'; ctx.fillRect(ox-8,oy-34,boss.w+16,14);
  ctx.fillStyle = pct > 0.5 ? '#2ecc71' : pct > 0.25 ? '#f39c12' : '#e74c3c';
  ctx.fillRect(ox-6,oy-32,Math.max(0,(boss.w+12)*pct),10);
  ctx.strokeStyle=GLD; ctx.lineWidth=2; ctx.strokeRect(ox-8,oy-34,boss.w+16,14);
  const names = {landlord:'LANDLORD', ratking:'RAT KING', recordexec:'RECORD EXEC'};
  ctx.fillStyle=GLD; ctx.font='8px "Press Start 2P"'; ctx.textAlign='center';
  ctx.fillText(names[boss.type]||'BOSS', ox+boss.w/2, oy-37);
}
