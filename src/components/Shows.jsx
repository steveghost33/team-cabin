        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
          {SHOWS.map((s, i) => (
            <div key={i} style={{
              ...
              border: `3px solid ${s.feat ? '#E2A820' : 'rgba(226,168,32,0.2)'}`,
              background: s.feat ? 'rgba(226,168,32,0.08)' : '#1C3D12',
            ...
            >
              <div style={{ textAlign: 'center' }}>
                ...
                <span style={{ fontFamily:'"Press Start 2P"', fontSize:'1rem', color:'#E2A820', display:'block' }}>{s.d}</span>
              </div>
              <div>
                <span style={{ fontFamily:'"VT323"', fontSize:'1.6rem', color:'#F5F0DC', display:'block' }}>{s.v}</span>
                <span style={{ fontFamily:'"Press Start 2P"', fontSize:'0.3rem', color:'#c8b830' }}>📍 {s.loc} — {s.t}</span>
              </div>
              <a href={s.ticketUrl} style={{
                fontFamily:'"Press Start 2P"', fontSize:'0.34rem',
                color:'#1C3D12', background: s.feat ? '#E2A820' : '#c8b830',
