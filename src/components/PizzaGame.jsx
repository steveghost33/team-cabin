  ...
  useEffect(() => {
    ...
    function drawBackground() {
      ...
      if(levelIdx===0){
        ...
        ng.addColorStop(0,'rgba(192,132,252,0)');ng.addColorStop(1,'rgba(192,132,252,0.18)');
    ...
    function drawBuilding(b) {
      ...
      if(b.isRenCen){
        ...
        for(let r=0;r<8;r++) for(let cc=0;cc<2;cc++){
          ...
          ctx.fillRect(bx+24+cc*12,GROUND-210+r*24,8,14);
        }
        return;
      }
      ...
      for(let r=0;r<b.wr;r++) for(let cc=0;cc<b.wc;cc++){
        ...
        if(wx+10<bx+b.w-4){
          ...
          ctx.fillStyle=lit?c.windowColor:'#050505';
          if(lit){ctx.shadowBlur=4;ctx.shadowColor=c.windowColor;}
    ...
    function drawTitle() {
      ...
      ctx.fillStyle='rgba(0,0,0,0.88)';ctx.fillRect(W/2-290,H/2-180,580,360);
      ctx.strokeStyle=C.gold;ctx.lineWidth=4;ctx.strokeRect(W/2-290,H/2-180,580,360);
      ctx.strokeStyle=C.goldL;ctx.lineWidth=1.5;ctx.strokeRect(W/2-284,H/2-174,568,348);
      ctx.fillStyle=C.gold;ctx.font='20px "Press Start 2P"';ctx.textAlign='center';
      ctx.fillText('DETROIT PIZZA QUEST',W/2,H/2-130);
      ctx.fillStyle=C.goldL;ctx.font='11px "Press Start 2P"';ctx.fillText('— Team Cabin Edition —',W/2,H/2-98);
      ctx.fillStyle=C.cream;ctx.font='9px "Press Start 2P"';
      ctx.fillText('3 LEVELS · 3 BOSSES · 1 CITY',W/2,H/2-66);
      ctx.fillText('JUMP ON ENEMIES TO DEFEAT THEM',W/2,H/2-44);
    ...
    function drawLevelTransition() {
      ...
      ctx.fillStyle='rgba(0,0,0,0.8)';ctx.fillRect(W/2-260,H/2-130,520,260);
