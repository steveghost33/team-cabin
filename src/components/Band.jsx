    ...
    <section id="band" style={{ padding: '5rem 2rem', maxWidth: 1100, margin: '0 auto' }}>
      ...
      <div style={{
        ...
        {MEMBERS.map((m, i) => {
          ...
          return (
            <div key={i} style={{
              border: `3px solid rgba(226,168,32,0.35)`,
              background: '#1C3D12',
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.borderColor = '#E2A820';
              }}
              onMouseLeave={e => {
                e.currentTarget.style.transform = '';
                e.currentTarget.style.boxShadow = '4px 4px 0 #000';
                e.currentTarget.style.borderColor = 'rgba(226,168,32,0.35)';
              }}
            >
              <div style={{
                background: '#152e0e',
                ...
                <div style={{
                  ...
                  backgroundImage: `repeating-linear-gradient(0deg,transparent,transparent 7px,rgba(226,168,32,0.04) 7px,rgba(226,168,32,0.04) 8px),repeating-linear-gradient(90deg,transparent,transparent 7px,rgba(226,168,32,0.04) 7px,rgba(226,168,32,0.04) 8px)`,
              ...
              <div style={{ padding: '1.2rem 1.5rem', width: '100%', display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
                ...
                <div style={{ fontFamily: '"Press Start 2P"', fontSize: '0.38rem', color: '#c8b830', textAlign: 'center' }}>{m.role}</div>
                <div style={{ height: 2, background: `repeating-linear-gradient(90deg,#E2A820 0,#E2A820 6px,transparent 6px,transparent 12px)`, opacity: 0.4 }} />
                <p style={{ fontFamily: '"VT323"', fontSize: '1.1rem', color: 'rgba(245,240,220,0.8)', textAlign: 'center', lineHeight: 1.5 }}>{m.bio}</p>
                <div style={{
                  fontFamily: '"Press Start 2P"', fontSize: '0.3rem', color: '#4A7A30',
