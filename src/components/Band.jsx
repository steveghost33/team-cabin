        ...
        {MEMBERS.map((m, i) => {
          ...
          return (
            <div key={i} style={{
              ...
              onMouseEnter={e => { e.currentTarget.style.transform='translate(-4px,-4px)'; e.currentTarget.style.boxShadow='7px 7px 0 #000'; e.currentTarget.style.borderColor=C.gold; }}
              onMouseLeave={e => { e.currentTarget.style.transform=''; e.currentTarget.style.boxShadow='4px 4px 0 #000'; e.currentTarget.style.borderColor='rgba(226,168,32,0.3)'; }}
            >
              {/* portrait area — darker solid bg, no grid */}
              <div style={{
                background: '#152e0e',
                width: '100%',
