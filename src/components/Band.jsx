        ...
        {MEMBERS.map((m, i) => {
          ...
          return (
            ...
            >
              ...
              <div style={{ fontFamily: '"Press Start 2P"', fontSize: '0.5rem', color: C.gold, textAlign: 'center' }}>
                {m.name}
              </div>
              <div style={{ fontFamily: '"VT323"', fontSize: '1.35rem', color: C.goldL, textAlign: 'center' }}>
                {m.role}
              </div>
              <p style={{ fontFamily: '"VT323"', fontSize: '1.15rem', color: 'rgba(245,240,220,0.65)', textAlign: 'center', lineHeight: 1.4 }}>
                {m.bio}
              </p>
              <div style={{ fontFamily: '"Press Start 2P"', fontSize: '0.32rem', color: C.greenL, textAlign: 'center' }}>
                🍕 {m.pizza}
              </div>
            </div>
          );
